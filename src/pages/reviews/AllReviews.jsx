...
function AllReviews() {
  ...
  const currentReviews = flaggedReviews.slice(
    startIndex,
  ...
  const calculateStars = (rev) => {
    const total =
      rev.venue + rev.ratio + rev.organization + rev.artists + rev.culture;
    const maxPossible = 5;
  ...
  return (
    <div className="p-5" style={{ minHeight: "100vh" }}>
      ...
      <div
        className="mt-5 d-flex flex-wrap gap-5 justify-content-center"
          ...
          <div key={index} className="d-md-flex mb-3 gap-5">
            <div>
              <div className="d-flex justify-content-end">
                <div className="d-flex align-items-end">{renderStars(rev)}</div>
              </div>
              <div
                className="rounded-4 p-3 mt-1 cardInfo"
                style={{ border: "3px solid #9BB09D" }}
              >
                <div className="d-flex flex-wrap gap-3 fw-bold justify-content-md-start justify-content-center">
                  <span className="d-flex align-items-md-start align-items-center fs-6 gap-2">
                    Venue <span className="fs-6">{rev.venue}</span>
                  </span>
                  <span className="d-flex align-items-md-start align-items-center fs-6 gap-2">
                    Ratio <span className="fs-6">{rev.ratio}</span>
                  </span>
                  <span className="d-flex align-items-md-start align-items-center fs-6 gap-2">
                    Organization{" "}
                    <span className="fs-6">{rev.organization}</span>
                  </span>
                  <span className="d-flex align-items-md-start align-items-center fs-6 gap-2">
                    Artists <span className="fs-6">{rev.artists}</span>
                  </span>
                  <span className="d-flex align-items-md-start align-items-center fs-6 gap-2">
                    Culture <span className="fs-6">{rev.culture}</span>
                  </span>
                </div>
