...
import "./RecentKudosFestival.css";
import RecentKudos from "../../../components/RecentKudos/RecentKudos";
...
const RecentKudosFestival = () => {
  return <RecentKudos users={users} />;
};

export default RecentKudosFestival;
