            ...
            <div className='p-5' style={{ backgroundColor: '#f6d46b' }}>
                <div className='d-md-flex justify-content-between'>
                    <div>
                        ...
                        <div> <img src={eliza} alt='eliza' /></div>
                    </div>
                    <div>
                        ...
                        <div className='d-flex  bg-transparent mt-2'>
                        ...
                        <div className='d-flex gap-2 bg-transparent mt-4'>
                ...
                <div className='d-flex justify-content-between'>
                    <div className='mt-3 px-5'>
                        <div className='d-flex gap-5 fw-bold'><h4 className='fw-bold' style={{ width: '160px' }}>UserName:</h4> <h4 className='fw-bold'> HugsOfFire</h4></div>
                        <div className='d-flex gap-5 fw-bold'><h4 className='fw-bold' style={{ width: '160px' }}>Email:</h4> <h4>voila@gmail.com</h4></div>
                        <div className='d-flex gap-5 fw-bold'><h4 className='fw-bold' style={{ width: '160px' }}>Name:</h4> <h4> Eliza</h4></div>
                        <div className='d-flex gap-5 fw-bold'><h4 className='fw-bold' style={{ width: '160px' }}>Dance alias:</h4> <h4> Hugs Of Fire</h4></div>
                        <div className='d-flex gap-5 fw-bold'><h4 className='fw-bold' style={{ width: '160px' }}>City:</h4> <h4> MTL</h4></div>
