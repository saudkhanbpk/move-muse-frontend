        ...
        <div className='  d-flex flex-column align-items-center justify-content-center p-5 ' style={{backgroundColor:'#fff7d8'}}>
            ...
            <div className='mt-3 d-flex gap-3'>
                <div className=' rounded-5 p-3 border border-3 border-gray'>
                    ...
                    <p>Creme de la creme of African dances and 1 Gala night of celebration of multiculturalism, diversity, the arts including performances and fashion shows by African designers. More of celebration of multiculturalism, diversity,
                        the arts including performances and fashion shows by African designers.</p>
                </div>
            ...
            <div className='mt-3 d-flex gap-3'>
                <div className=' rounded-5 p-3 border border-3 border-gray'>
                    ...
                    <p>Creme de la creme of African dances and 1 Gala night of celebration of multiculturalism, diversity, the arts including performances and fashion shows by African designers. More of celebration of multiculturalism,
                         diversity, the arts including performances and fashion shows by African designers.</p>
                </div>
                <div className="d-flex justify-content-center align-items-center">
