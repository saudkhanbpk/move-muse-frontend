...
//                 className={`form-control rounded ${errors.title ? "border-danger" : ""}`}
//                 style={{
...
//                     type="checkbox"
//                     name="role"
//                     className={`form-check-input rounded custom-checkbox ${errors.role ? "border-danger" : ""}`}
...
//                           type="radio"
//                           required
//                           className={`form-check-input rounded ${errors.role ? "border-danger" : ""}`}
//                           name="as"
//                           id={`role-${id}`}
...
//                           }
//                         }}
//                         className={`form-control rounded ${errors.rating ? "border-danger" : ""}`}
//                         style={{
//                           backgroundColor: "#F2E7CB",
//                           border: "2px solid gray",
//                           outline: "none",
...
//                 className={`form-control rounded-4 ${errors.description ? "border-danger" : ""}`}
//                 rows="3"
//                 style={{
//                   backgroundColor: "#F2E7CB",
//                   border: "2px solid gray",
