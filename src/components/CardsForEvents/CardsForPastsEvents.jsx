...
import { FaCalendarAlt, FaMapMarkerAlt, FaPeriscope, FaUser, } from "react-icons/fa";
...
const CardsForPastsEvents = () => {
    ...
    useEffect(() => {
        const fetchPastEvents = async () => {
            try {
                const response = await axios.get(`${BaseUrl}/api/v1/events/past-events`);
    ...
    //     try {
    //         await axios.delete(`${BaseUrl}/api/v1/events/past-event/${eventId}`);
                ...
                {currentEvents.map((event) => (
                    ...
                    >
                        <div className="imag-wrapper">
                            <img
                                src={event.image || 'https://img.freepik.com/free-vector/party-people-silhouetes-background_1048-911.jpg?semt=ais_hybrid'}
